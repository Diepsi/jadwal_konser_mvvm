// lib/UI/views/home_screen.dart

import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../data/models/band_model.dart';
import '../viewmodels/main_viewmodel.dart';
import '../../globals.dart'; // PERBAIKAN: Sekarang mengambil dari globals.dart
import '../../screens/detail_screen.dart'; 

class HomeScreen extends StatelessWidget {
  const HomeScreen({super.key});

  // HELPER: Logika penentuan sumber gambar
  ...
  Widget _buildGenreTags(BuildContext context, MainViewModel viewModel) {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: genreTags.length, // Berhasil diakses dari globals
        padding: const EdgeInsets.symmetric(horizontal: 10),
        itemBuilder: (context, index) {
          final genre = genreTags[index];
          final isSelected = genre == viewModel.selectedGenre;
          final genreColor = genreColors[genre] ?? Colors.white; // Berhasil diakses dari globals
          ...
          return Padding(
            ...
            child: ActionChip(
              ...
              backgroundColor: isSelected ? genreColor : Theme.of(context).colorScheme.surface,
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final genreColor = genreColors[band.genre] ?? Colors.white; // Berhasil diakses dari globals
  ...
  Widget _buildConcertList(BuildContext context, MainViewModel viewModel) {
    ...
    return ListView.separated(
      ...
      separatorBuilder: (_, __) => const Divider(color: Color(0xFF333355), height: 1),
      itemBuilder: (context, index) {
